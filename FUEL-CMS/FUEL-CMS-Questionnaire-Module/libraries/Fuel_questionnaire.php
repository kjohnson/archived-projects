...
class Fuel_questionnaire extends Fuel_advanced_module {
	
	public $name = "questionnaire"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->questionnaire->my_method()
	 */	
