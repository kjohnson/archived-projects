...
class Answers_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Answer'; // the name of the record class (if it can't be determined)
	...
	public $foreign_keys = array( // map foreign keys to table models
		'question_id' => array(QUESTIONNAIRE_FOLDER => 'questions_model'),
		'respondent_id' => array(QUESTIONNAIRE_FOLDER => 'respondents_model'),
		);
	...
	{
		parent::__construct('fuel_questionnaire_answers'); // table name
	}
...
class Answer_model extends Base_module_record {
