...
class Questions_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Question'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('fuel_questionnaire_questions'); // table name
	}
...
class Question_model extends Base_module_record {
