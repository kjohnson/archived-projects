...
class Fuel_chooser extends Fuel_advanced_module {
	
	public $name = "chooser"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->chooser->my_method()
	 */	
