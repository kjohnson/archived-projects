...
class Fuel_event extends Fuel_advanced_module {
	
	public $name = "event"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->event->my_method()
	 */	
