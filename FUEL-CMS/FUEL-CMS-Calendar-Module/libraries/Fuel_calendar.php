...
class Fuel_calendar extends Fuel_advanced_module {
	
	public $name = "calendar"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->calendar->my_method()
	 */	
